...
NB: in Elm you can `batch` multiple commands in a single one. For now, this is not supported by Salix, since I don't understand the semantics of multiple commands resulting from a single `update` invocation.  
